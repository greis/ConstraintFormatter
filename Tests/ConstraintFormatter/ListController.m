...
- (void)viewDidLoad {
  ...
  self.formats = @{
                 ...
                 @"Left": @[@"view1.left == superview.left", @"view2.left == view1.right", @"view1.width == superview.width * 0.5", @"view1.height == superview.height", @"view2.size == view1.size", @"view1.centerY == superview.centerY", @"view2.centerY == superview.centerY"],
                 };
}
